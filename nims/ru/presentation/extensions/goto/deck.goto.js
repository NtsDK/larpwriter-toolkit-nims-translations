...
//    var $datalist = $(options.selectors.gotoDatalist);
    var $datalist = $(options.selectors.gotoInput);

    $.each($.deck('getSlides'), function(i, $slide) {
      var id = $slide.attr('id');
      var label = $slide.attr('label');
      if (id) {
//        $datalist.append('<option value="' + id + '" label="' + label + '">');
        $datalist.append('<option value="' + id + '">' + label + '</option>');
